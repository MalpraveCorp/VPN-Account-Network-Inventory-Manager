...
def create_user_hardcoded(conn, email, first_ip, last_ip, subnet):
...
def handler_create_user_hardcoded(conn, args):
    if len(args) == 4:
...
if args["show_accounts"] == True:
    printer(args, get_accounts(cur))

if args["show_accounts_full"] == True:
    printer(args, get_accounts_full(cur))

if args["show_pools"] == True:
    printer(args, get_ippools(cur))

if args["create_account"] != None:
    create_user(conn, args["create_account"])

if args["create_account_hardcoded"] != None:
    handler_create_user_hardcoded(conn, args["create_account_hardcoded"])

if args["revoke_account"] != None:
    revoke_user(conn, args["revoke_account"])

if args["create_pool"] != None:
